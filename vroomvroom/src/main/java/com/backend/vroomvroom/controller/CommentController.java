...
public class CommentController {
    ...
    public CommentResponseDto commentRegister(@Valid @RequestBody CommentRequestDto commentRequestDto) {
        log.info("comment register, request : {}", commentRequestDto);
        log.info("comment register, userId : {}", commentRequestDto.getUserId());
